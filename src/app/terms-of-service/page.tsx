        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="space-y-6">
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-app-text">1. Description of Service</h2>
              <p className="text-app-textMuted">
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-app-text">2. Eligibility</h2>
              <p className="text-app-textMuted">
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-app-text">3. User Content</h2>
              <p className="text-app-textMuted">
              ...
              <ul className="list-disc pl-5 text-app-textMuted space-y-1">
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-app-text">4. AI-Generated Content</h2>
              <p className="text-app-textMuted">
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-app-text">5. Intellectual Property</h2>
              <p className="text-app-textMuted">
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-app-text">6. Prohibited Activities</h2>
              <p className="text-app-textMuted">You may not:</p>
              <ul className="list-disc pl-5 text-app-textMuted space-y-1">
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-app-text">7. Termination</h2>
              <p className="text-app-textMuted">
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-app-text">8. Disclaimers</h2>
              <p className="text-app-textMuted">
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-app-text">9. Governing Law</h2>
              <p className="text-app-textMuted">
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-app-text">10. Contact</h2>
              <p className="text-app-textMuted">

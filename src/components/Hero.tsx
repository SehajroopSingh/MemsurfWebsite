        ...
        <section className="relative">
            <div className="relative min-h-screen flex flex-col items-center justify-start pt-24 sm:pt-28 pb-0 gap-10">
                ...
                <div className="relative z-[45] w-full max-w-7xl mx-auto px-4 flex flex-col lg:flex-row lg:items-start lg:gap-5 gap-4 sm:gap-6 overflow-visible">
                    ...
                    >
                        <h1 className="text-7xl sm:text-8xl md:text-7xl lg:text-8xl font-bold mb-6 leading-tight tracking-tight">
                            <span
                        ...
                        <p className="text-3xl sm:text-4xl md:text-3xl text-gray-300 mb-0 max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-3xl mx-auto lg:mx-0 leading-relaxed">

  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="inline-flex items-center gap-2 text-xl sm:text-base text-gray-700 hover:text-gray-900 hover:bg-[#5865F2]/10 transition-all duration-200 font-medium whitespace-nowrap border-2 border-black rounded-full sm:rounded-3xl pl-2 pr-4 py-2 sm:pl-1 sm:pr-3 sm:py-1.5"

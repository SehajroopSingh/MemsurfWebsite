...
const PHONE_HERO_ASPECT_CLASS = 'aspect-[672/1250] sm:aspect-[672/1000] md:aspect-[672/620]'
...
function ScrollAnimatedPhone({
  ...
  return (
    <group
      ...
      scale={isSmallViewport ? 1.22 : 0.96}
    >
      <Suspense
        fallback={
    ...
    <PhoneHeroCanvasBoundary fallback={fallback}>
      <PhoneHeroCanvasFrame className={className}>
        ...
        >
          ...
          <group position={[isSmallViewport ? 0 : 0.35, isSmallViewport ? -0.35 : -0.35, 0]}>
            <Float

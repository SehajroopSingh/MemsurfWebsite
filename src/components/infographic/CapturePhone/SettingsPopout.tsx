    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                className="hidden w-[240px] shrink-0 flex-col justify-center gap-6 py-2 text-left sm:w-[280px] sm:max-w-[300px] sm:gap-8 sm:py-4 md:flex md:max-w-[320px] lg:min-h-[540px] lg:gap-10"
            >
                {/* Quiz Difficulty */}
                <motion.div
